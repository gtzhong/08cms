...
$advtagadv_fcatalog146 = array (
  ...
  'tclass' => 'advertising',
  'template' => '<div class="mb5 wrap">{if $v[\'html\']}{html}{elseif $v[\'image\']}<a href="{link}" target="_blank"><img {c$image [tclass=image/] [tname=image/] [val=u/] [maxwidth=1200/] [maxheight=70/]} src="{url}"  height="70" width="1200"
