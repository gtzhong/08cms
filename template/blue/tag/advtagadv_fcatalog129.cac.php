...
$advtagadv_fcatalog129 = array (
  ...
  'template' => '<div class="flash mb10 bd">
                    <div id="big" class="big">
                        <ul>
                            {c$v3_hdp [cname=»ÃµÆÆ¬/] [tclass=farchives/] [limits=4/] [casource=129/] [orderstr=a.vieworder ASC/] [validperiod=1/]}
                    ...
                    <ul id="sml" class="sml clearfix">{c$v3_hdpsml [cname=»ÃµÆÆ¬2/] [tclass=farchives/] [limits=4/] [casource=129/] [orderstr=a.vieworder ASC/] [validperiod=1/]}<li {if $v[\'sn_row\']==1}class="act"{/if}><a href="{link}" >{c$ad_image70_52 [cname=ad_image70_52/] [tclass=image/] [tname=image/] [val=u/] [maxwidth=70/] [maxheight=52/]}<img src="{url}" width="70" height="52" alt="{$v[\'subject\']}"/>{/c$ad_image70_52}<b></b></a></li>{/c$v3_hdpsml}
                    </ul>
                </div>
