...
var Search = {
	...
	showSelfPoint: function(){
		var me = this;
   		var mp = me.map;	
	// 复杂的自定义覆盖物    
	var txt = '<div class="searchRichMarker" id="tip'+me.config.aid+'"><div><em>'+me.config.subject+'<span style="display:none;">|'+me.config.dj+'元/平方米</span></em></div></div>', mouseoverTxt = '<div class="searchRichMarker" id="tip'+me.config.aid+'"><div><em>'+me.config.subject+'<span>|'+me.config.dj+'元/平方米</span></em></div></div>' ;
