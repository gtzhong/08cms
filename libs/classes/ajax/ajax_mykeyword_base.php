 ...
 * Ñ¡Ôñ¹Ø¼ü×Ö
 *
 * @example   ÇëÇó·¶ÀýURL£ºhttp://nv50.08cms.com/index.php?/ajax/mykeyword/
...
class _08_M_Ajax_Mykeyword_Base extends _08_Models_Base
{
    ...
    {    	
    	$str = '<div class="coolbg4" onmousedown="aListSetMoving.Move(\'mykeyword\',event)">[<a href="javascript:void(0)" onclick="javascript:HideObj(\'mykeyword\');">¹Ø±Õ</a>]</div><div class="wsselect">';
