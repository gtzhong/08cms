...
//搜索项目 ****************************
//s_additem($key,$cfg)
$oL->s_additem('keyword',array('fields' => array('p.subject' => '标题','p.mname' => '推荐人用户名','p.pushid' => '信息ID','p.fromid' => '来源ID','p.pid3' => '楼盘ID','a.subject' => '楼盘名称'),));//keys留空则默认为array('a.subject' => '标题','a.mname' => '会员','a.aid' => '文档ID')
